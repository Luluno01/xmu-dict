 ...
 * @returns {Array} parsed grade data. Each element contains the grade info of the specific term
 * @returns {Array} data format: [term: {name: {string}, subjects: [{name: {string}, credit: {string}, courseType: {string}, takingType: {string}, grade: {string}, specialReason: {string}, ranking: {string}}]}]
 */
module.exports = (text) => {
